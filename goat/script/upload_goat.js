...
uploadBtn.addEventListener("click", async () => {
  ...
  const price = document.getElementById("goatPrice").value.trim();
  ...
  try {
    ...
    status.textContent = "✅ Goat uploaded successfully!";
