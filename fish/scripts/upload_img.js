...
function setupUploadUI() {
  ...
  async function uploadImage() {
    ...
    try {
      ...
      const location = document.getElementById("fishLocation").value.trim();
      const phone = document.getElementById("phone").value.trim();
      const price = document.getElementById("fishPrice").value.trim();
      const weight = document.getElementById("fishWeight").value.trim();
      ...
      showStatus("Fish uploaded successfully! 🐟", "success");
